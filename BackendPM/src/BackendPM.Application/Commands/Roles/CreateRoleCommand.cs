...
/// 创建角色命令
/// </summary>
public class CreateRoleCommand(string name, string code, string? description, List<Guid>? permissionIds = null) : BaseCommand<RoleDto>
{
    /// <summary>
    /// 角色名称
    /// </summary>
...
/// 创建角色命令处理器
/// </summary>
public class CreateRoleCommandHandler(IUnitOfWork unitOfWork, ILogger<CreateRoleCommandHandler> logger) : IRequestHandler<CreateRoleCommand, RoleDto>
{
