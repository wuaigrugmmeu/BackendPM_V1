...
/// 删除角色命令
/// </summary>
public class DeleteRoleCommand(Guid roleId) : BaseCommand
{
    /// <summary>
    /// 角色ID
    /// </summary>
...
/// 删除角色命令处理器
/// </summary>
public class DeleteRoleCommandHandler(IUnitOfWork unitOfWork, ILogger<DeleteRoleCommandHandler> logger) : IRequestHandler<DeleteRoleCommand>
{
