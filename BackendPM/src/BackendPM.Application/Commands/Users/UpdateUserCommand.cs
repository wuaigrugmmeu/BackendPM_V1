...
/// 更新用户命令
/// </summary>
public class UpdateUserCommand(Guid userId, string email, string? fullName, bool isActive) : BaseCommand<UserDto>
{
    /// <summary>
    /// 用户ID
    /// </summary>
...
/// 更新用户命令处理器
/// </summary>
public class UpdateUserCommandHandler(IUnitOfWork unitOfWork, ILogger<UpdateUserCommandHandler> logger) : IRequestHandler<UpdateUserCommand, UserDto>
{
