...
/// 根据ID获取角色查询
/// </summary>
public class GetRoleByIdQuery(Guid roleId) : BaseQuery<RoleDto>
{
    /// <summary>
    /// 角色ID
    /// </summary>
...
/// 根据ID获取角色查询处理器
/// </summary>
public class GetRoleByIdQueryHandler(IUnitOfWork unitOfWork) : IRequestHandler<GetRoleByIdQuery, RoleDto>
{
